...
class WishlistCanonicalResourceTest extends WishlistResourceTestBase {
  ...
  public function testGetWishlist() {
    ...
    $response = $this->request('GET', $url, $request_options);
    $this->assertResourceResponse(200, FALSE, $response, ['commerce_wishlist:1', 'config:rest.resource.commerce_wishlist_canonical', 'config:rest.settings', 'http_response'], [''], FALSE, 'MISS');
