...
class WishlistAccessApiResourceTest extends WishlistResourceTestBase {
  ...
  public function testNoParameters() {
    ...
    $this->assertResourceResponse(200, FALSE, $response, ['commerce_wishlist:1', 'config:rest.resource.commerce_wishlist_collection', 'config:rest.settings', 'http_response'], ['wishlist'], FALSE, 'MISS');
  }
